...
# secondo frammento 
FILE_DA_CONSEGNARE2= processo_wator.c processo_wator.h visualizer.c wator.c wator.h watorscript

# terzo frammento 
FILE_DA_CONSEGNARE3= processo_wator.c processo_wator.h visualizer.c wator.c wator.h watorscript Makefile Relazione.pdf
...
wator: processo_wator.o
	$(CC) processo_wator.o -o wator $(LIBS) -lWator -lpthread
...
processo_wator.o: processo_wator.c wator.h processo_wator.h
visualizer.o: visualizer.c wator.h processo_wator.h
